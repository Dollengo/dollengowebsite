...
export default function Page() {
  return (
    <section>
      ...
      <div className="mb-4">
        <img src="https://github.com/Dollengo/dollengostudioswebsite//blob/168e00389a12e0bd24c32d3d0a2a6ececf56d116/app/imgs/DollengoStudios.png" alt="dollengo-studios-logo" className="w-full h-auto" />
      </div>
      <p className="mb-4">
